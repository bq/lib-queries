...
public class JacksonQueryParserTest {
    ...
    @Test
    public void testDateWithOffsetValue() throws MalformedJsonQueryException {
        String eqString = "[{\"$lt\":{\"date\":\"ISODate(2012-07-14T01:00:00+01:00)\"}}]";
        validateDateTest(eqString);
    }

    @Test
    public void testDateWithMillisValue() throws MalformedJsonQueryException {
        String eqString = "[{\"$lt\":{\"date\":\"ISODate(2012-07-14T01:00:00.001Z)\"}}]";
        validateDateTest(eqString);
    }

    @Test
    public void testDateValue() throws MalformedJsonQueryException {
        String eqString = "[{\"$lt\":{\"date\":\"ISODate(2012-07-14T01:00:00Z)\"}}]";
        validateDateTest(eqString);
    }

    private void validateDateTest(String eqString) throws MalformedJsonQueryException {
        ResourceQuery resourceQuery = jacksonQueryParser.parse(eqString);
        QueryNode node = resourceQuery.iterator().next();
