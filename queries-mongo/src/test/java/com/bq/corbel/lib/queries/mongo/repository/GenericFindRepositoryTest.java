...
import com.bq.corbel.lib.queries.mongo.TestBean;
...
public class GenericFindRepositoryTest {
    ...
    public void testFind() {
        ...
        List<TestBean> result = repo.find(resourceQuery, new Pagination(10, 100), new Sort(Direction.ASC.toString(), NAME));
    ...
    public void testFindOr() {
        ...
        List<TestBean> result = repo.find(resourceQueries, new Pagination(10, 100), new Sort(Direction.ASC.toString(), NAME));
